...
const navigationLinks = document.querySelectorAll('.header-btn-con a');

if (headerContainer && menuToggle) {
    menuToggle.addEventListener('click', () => {
        const isMenuOpen = headerContainer.classList.toggle('header-menu-open');
...
certificateFilters.forEach(button => {
    button.addEventListener('click', () => {
        ...
        if (filterValue.includes('2569') || filterValue.includes('2568') || filterValue.includes('2567') ) {
            filtercards('all');
            return;
        }
...
const targetDate = new Date("2026-09-07T17:30:00").getTime();
