    ...
    function handleAIResponse(inputText) {
        ...
        setTimeout(() => {
            ...
            // 7. คำทักทายทั่วไป
                ...
                reply = "เจ้าของเว็บไซต์นี้ มีความสามารถหลากหลาย ทักษะ ด้านคอมพิวเตอร์ : สร้างเว็บไซต์ของตัวเอง , สร้างสรรค์เกมจากโปรแกรมคอมพิวเตอร์ , พัฒนาระบบ IoT  ทักษะเสริม: ความเป็นผู้นำ , การสร้างพลังเขิงบวกให้แก่คนรอบข้าง , การสื่อสาร , การตัวเองตัวเอง , การเรียนรู้ที่รวดเร็วกับสิ่งที่ชอบ   ";
            }
